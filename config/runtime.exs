...
if config_env() != :test do
  ...
  config :my_auth_system,
    ...
    max_upload_size_mb: String.to_integer(System.get_env("MAX_UPLOAD_SIZE_MB", "2"))
end
...
# #
# #     PHX_SERVER=true bin/my_auth_system start
# #
# # Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# # script that automatically sets the env var above.
# if System.get_env("PHX_SERVER") do
#   config :my_auth_system, MyAuthSystemWeb.Endpoint, server: true
# end
...
#   config :my_auth_system, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
#   #
#   #     config :my_auth_system, MyAuthSystem.Mailer,
